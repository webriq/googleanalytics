...
class Bind implements BindInterface, ServiceLocatorAwareInterface
{
    ...
    {
        if ($this->getForm()->get('analytics') && $this->getForm()->get('analytics')->get('dashboardDiagramReport')){
            /*@var $select \Zork\Form\Element\Select */
            $select = $this->getForm()->get('analytics')->get('dashboardDiagramReport');
            
            /* @var $dataField \Zork\Form\Element\Hidden  */
            $dataField = $this->getForm()->get('analytics')->get('reports');
